...
export default async function UseCasesPage() {
  const CATEGORIES = {
    'classroom-use': {
      ...
      slug: 'classroom-use',
      description:
        'Examples of AI tools being used directly in classroom instruction and student learning',
    },
    'lesson-planning': {
      name: 'Lesson Planning',
      slug: 'lesson-planning',
      description:
        'How educators are using AI to enhance lesson planning and curriculum development',
    },
    'student-support': {
      name: 'Student Support',
      slug: 'student-support',
      description:
        'Applications of AI in providing additional support and accommodations for students',
    },
    assessment: {
      name: 'Assessment',
      slug: 'assessment',
  ...
  const [useCasesByCategory, allTags] = await Promise.all([getUseCasesByCategory(), getAllTags()]);
