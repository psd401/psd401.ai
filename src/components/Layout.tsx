          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              <NextLink
                ...
                aria-label="Visit Peninsula School District on Facebook (opens in new tab)"
              >
              ...
              <NextLink
                ...
                target="_blank"
                className="text-white/80 hover:text-sea-glass"
                aria-label="Visit Peninsula School District on LinkedIn (opens in new tab)"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <NextLink
                ...
                className="text-white/80 hover:text-sea-glass"
                aria-label="View psd401.ai repository on GitHub (opens in new tab)"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
